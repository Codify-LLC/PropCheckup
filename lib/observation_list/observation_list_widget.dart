...
class ObservationListWidget extends StatefulWidget {
  const ObservationListWidget({Key? key}) : super(key: key);

  @override
  _ObservationListWidgetState createState() => _ObservationListWidgetState();
}
                      ...
                      return Padding(
                        ...
                        child: Container(
                          ...
                          child: InkWell(
                            onTap: () async {
                              FFAppState().update(() {
                                FFAppState().RoomLS = FFAppState().FlatLS;
                              });
                              await Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                                      NavBarPage(initialPage: 'ReInspection'),
                                ),
                              );
                            },
                            child: Row(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              listViewObservationRecord.room!,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyText2
                                                  .override(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Text(
                                              listViewObservationRecord.type!,
                                              style: FlutterFlowTheme.of(
                                                      context)
                                                  .bodyText1
                                                  .override(
